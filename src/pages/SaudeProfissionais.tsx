    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 20 }}>
        ...
        <select value={form.tipo} onChange={e => setForm({ ...form, tipo: e.target.value })}>
          ...
          <option value="diretor">Diretor (vê tudo)</option>
        </select>
        ...
        {editandoId && (
          <button onClick={() => { setEditandoId(null); setForm({ nome: "", email: "", telefone: "", especialidade: "", tipo: "profissional", supervisorId: "", modalidade: "presencial" }); }}>
            Cancelar
          </button>
        )}
      </div>
            ...
            return (
              <tr key={p.id}>
                ...
                <td>
                  ...
                  <button onClick={() => excluir(p.id, p.nome)} style={{ marginLeft: 8, background: "#dc3545", color: "#fff" }}>Excluir</button>
                </td>
              </tr>
            );
          })}
